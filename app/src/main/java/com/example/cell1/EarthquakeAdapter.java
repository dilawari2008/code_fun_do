...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    ToDoActivity earthquakeActivity;
   ...
   public String latitude,longitude;
    ...
    public void locationInitializer() {
       // lati = earthquakeActivity.lati;
       // longi = earthquakeActivity.longi;
        //Log.d("vinay", lati + " " + longi);
    }
    ...
    public EarthquakeAdapter(Context context, List<Earthquake> earthquakes) {
        ...
        earthquakeActivity = (ToDoActivity) context;
    }
    ...
    public void locate() {
       ...
       /* locationInitializer();
        ...
        TextView longitude = (TextView) listItemView.findViewById(R.id.longitude);
        longitude.setText(longi);*/

        returnListItemView();
    }

    public View returnListItemView() {
